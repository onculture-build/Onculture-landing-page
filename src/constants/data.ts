...
export const subScriptionCourse = [
  {
    ...
    information: ["2 months access", "quarterly reporting"],
    price: "5",
    staySafe: true,
    cultureClinic: true,
    others: false,
...
export const TemplateCategories = {
  Productivity: {
    ...
    desc: "Team members are required to share what they worked on daily, and blockers they had and what they plan to work on the following day.",
    templates: [{ icon: rocket, title: "Team Sum Up" }],
  },

  Engagement: {
    title: "Interaction/Connection & Engagement",
    desc: "Team members are required to share what they worked on daily, and blockers they had and what they plan to work on the following day.",
    templates: [
      { icon: rocket, title: "Peer 1:1" },
      { icon: pencil, title: "Fireside Chats/Spark" },
      { icon: speechBalloon, title: "Anonymous Complaint and suggestion box" },
    ],
  },
  ...
  Motivation: {
    ...
    desc: "Team members are required to share what they worked on daily, and blockers they had and what they plan to work on the following day.",
    templates: [
      { icon: glowingStar, title: "Shout-outs (with company value)" },
      { icon: sportsMedal, title: "Value star votes" },
    ],
  },
};
