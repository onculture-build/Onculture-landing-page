...
const editProfileSchema = Yup.object().shape({
  adminName: Yup.string().required("Admin name is a required"),
...
const CustomMultipleField = ({
  ...
  return (
    <div
      className={`${dashboardStyle.formBoxes} ${dashboardStyle.customInputField}`}
    >
      <label htmlFor={props.id || props.name}>{label}*</label>
          ...
          return (
            <div key={index} className={dashboardStyle.wrapInput}>
              <input
                ...
                {...props}
                onChange={(e) => {
                  const updateValue = field.value.map(
                    (item: string, idx: any) => {
                      if (idx === index) {
                  ...
                  if (e.target.value === "") {
                    const newList = field.value.filter(
                      (currValue: string) => currValue !== val
                    );
...
const EditAdminProfile = () => {
  ...
  const companyUpdate = async (
    ...
    const { data } = await axios.post(`${process.env.REACT_APP_API_PROXY}/updateCompany`, payloadData, config);
              ...
              {({
                ...
                <Form className={dashboardStyle.mainEditForm}>
                    ...
                    <div className={dashboardStyle.editAdminDetails}>
                      <div className={dashboardStyle.formBoxes}>
                        ...
                        {errors.adminName && touched.adminName ? (
                          <span className={dashboardStyle.errorMsg}>
                            {errors.adminName}
                          </span>
                        ) : null}
                      </div>
                    ...
                    <div className={dashboardStyle.editCompanyDetails}>
                      ...
                      <div className={dashboardStyle.wtttest}>
                        <MyTextArea
                          ...
                          name="vision"
                          id="vision"
                          className={dashboardStyle.valuesTextField}
                          placeholder="vision"
                        />
                      </div>
                    </div>
                  ...
                  <div className={dashboardStyle.editProfilebtns}>
                    <button
                      type="submit"
                      className={dashboardStyle.submitEdit}
                      // onSubmit={(e)=>handleSubmit()}
                    >
                      Submit
                    </button>
                    <button
                      className={dashboardStyle.cancelEdit}
